package com.breezefieldbluebarry.features.logoutsync.presentation
...
import com.breezefieldbluebarry.app.AppDatabase
...
import com.breezefieldbluebarry.app.utils.AppUtils
import com.breezefieldbluebarry.app.utils.Toaster
import com.breezefieldbluebarry.base.BaseResponse
import com.breezefieldbluebarry.base.presentation.BaseActivity
import com.breezefieldbluebarry.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldbluebarry.features.billing.api.AddBillingRepoProvider
import com.breezefieldbluebarry.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldbluebarry.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldbluebarry.features.document.model.AddEditDocumentInputParams
import com.breezefieldbluebarry.features.document.model.DocumentAttachmentModel
...
import com.breezefieldbluebarry.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldbluebarry.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldbluebarry.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldbluebarry.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldbluebarry.features.orderhistory.model.*
...
import com.breezefieldbluebarry.features.quotation.model.AddQuotInputModel
import com.breezefieldbluebarry.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldbluebarry.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldbluebarry.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldbluebarry.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldbluebarry.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldbluebarry.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldbluebarry.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldbluebarry.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldbluebarry.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldbluebarry.mappackage.SendBrod
import com.breezefieldbluebarry.widgets.AppCustomTextView
import com.breezefieldbluebarry.MonitorService
import com.breezefieldbluebarry.MySingleton
import com.breezefieldbluebarry.features.addshop.model.*
import com.breezefieldbluebarry.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezefieldbluebarry.features.addshop.presentation.ShopExtraContactReq
import com.breezefieldbluebarry.features.addshop.presentation.multiContactRequestData
...
import com.breezefieldbluebarry.features.login.model.GetConcurrentUserResponse
import com.breezefieldbluebarry.features.login.model.WhatsappApiData
import com.breezefieldbluebarry.features.performance.model.Gps_status_list
import com.breezefieldbluebarry.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldbluebarry.features.returnsOrder.ReturnProductList
import com.breezefieldbluebarry.features.returnsOrder.ReturnRequest
import com.breezefieldbluebarry.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbluebarrylogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbluebarrylogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbluebarrylogsample/log.zip").path);
