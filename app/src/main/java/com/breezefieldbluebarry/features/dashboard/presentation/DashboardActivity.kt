package com.breezefieldbluebarry.features.dashboard.presentation
...
import com.breezefieldbluebarry.*
import com.breezefieldbluebarry.R
import com.breezefieldbluebarry.app.*
import com.breezefieldbluebarry.app.NewFileUtils.browseDocuments
import com.breezefieldbluebarry.app.NewFileUtils.browsePDFDocuments
import com.breezefieldbluebarry.app.NewFileUtils.getExtension
import com.breezefieldbluebarry.app.domain.*
import com.breezefieldbluebarry.app.types.DashboardType
import com.breezefieldbluebarry.app.types.FragType
import com.breezefieldbluebarry.app.types.TopBarConfig
import com.breezefieldbluebarry.app.uiaction.DisplayAlert
import com.breezefieldbluebarry.app.utils.*
import com.breezefieldbluebarry.app.utils.AppUtils.Companion.isProfile
import com.breezefieldbluebarry.base.BaseResponse
import com.breezefieldbluebarry.base.presentation.BaseActivity
import com.breezefieldbluebarry.base.presentation.BaseFragment
import com.breezefieldbluebarry.features.NewQuotation.*
import com.breezefieldbluebarry.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldbluebarry.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldbluebarry.features.SearchLocation.SearchLocationFragment
import com.breezefieldbluebarry.features.SearchLocation.locationInfoModel
import com.breezefieldbluebarry.features.TA.ViewAllTAListFragment
import com.breezefieldbluebarry.features.achievement.AchievementFragment
import com.breezefieldbluebarry.features.activities.presentation.*
import com.breezefieldbluebarry.features.addAttendence.*
import com.breezefieldbluebarry.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldbluebarry.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldbluebarry.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldbluebarry.features.addAttendence.model.GetReportToResponse
import com.breezefieldbluebarry.features.addAttendence.model.Leave_list_Response
import com.breezefieldbluebarry.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldbluebarry.features.addshop.presentation.AddShopFragment
import com.breezefieldbluebarry.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldbluebarry.features.addshop.presentation.ScanImageFragment
import com.breezefieldbluebarry.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldbluebarry.features.alarm.model.AlarmData
import com.breezefieldbluebarry.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldbluebarry.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldbluebarry.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldbluebarry.features.alarm.presetation.VisitReportFragment
import com.breezefieldbluebarry.features.attendance.AttendanceFragment
import com.breezefieldbluebarry.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldbluebarry.features.attendance.model.AttendanceRequest
import com.breezefieldbluebarry.features.attendance.model.AttendanceResponse
import com.breezefieldbluebarry.features.averageshop.presentation.AverageShopFragment
import com.breezefieldbluebarry.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldbluebarry.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldbluebarry.features.beatCustom.TeamBeatListFragment
import com.breezefieldbluebarry.features.billing.presentation.AddBillingFragment
import com.breezefieldbluebarry.features.billing.presentation.BillingDetailsFragment
import com.breezefieldbluebarry.features.billing.presentation.BillingListFragment
import com.breezefieldbluebarry.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldbluebarry.features.chat.model.ChatListDataModel
import com.breezefieldbluebarry.features.chat.model.ChatUserDataModel
import com.breezefieldbluebarry.features.chat.model.GroupUserDataModel
import com.breezefieldbluebarry.features.chat.presentation.*
import com.breezefieldbluebarry.features.chatbot.presentation.ChatBotFragment
import com.breezefieldbluebarry.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldbluebarry.features.chatbot.presentation.ReportsFragment
import com.breezefieldbluebarry.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldbluebarry.features.commondialog.presentation.CommonDialog
import com.breezefieldbluebarry.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldbluebarry.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldbluebarry.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldbluebarry.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldbluebarry.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldbluebarry.features.contacts.ContactDtls
import com.breezefieldbluebarry.features.contacts.ContactGr
import com.breezefieldbluebarry.features.contacts.ContactsAddFrag
import com.breezefieldbluebarry.features.contacts.ContactsFrag
import com.breezefieldbluebarry.features.contacts.SchedulerViewFrag
import com.breezefieldbluebarry.features.contacts.SchedulerAddFormFrag
import com.breezefieldbluebarry.features.contacts.TemplateAddFrag
import com.breezefieldbluebarry.features.contacts.TemplateViewFrag
import com.breezefieldbluebarry.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldbluebarry.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldbluebarry.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldbluebarry.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldbluebarry.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldbluebarry.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldbluebarry.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldbluebarry.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldbluebarry.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldbluebarry.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldbluebarry.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldbluebarry.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldbluebarry.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldbluebarry.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldbluebarry.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldbluebarry.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldbluebarry.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldbluebarry.features.document.presentation.DocumentListFragment
import com.breezefieldbluebarry.features.document.presentation.DocumentTypeListFragment
import com.breezefieldbluebarry.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldbluebarry.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldbluebarry.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldbluebarry.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldbluebarry.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldbluebarry.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldbluebarry.features.home.presentation.HomeFragment
import com.breezefieldbluebarry.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldbluebarry.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldbluebarry.features.know_your_state.KnowYourStateFragment
import com.breezefieldbluebarry.features.lead.LeadFrag
import com.breezefieldbluebarry.features.lead.ViewLeadFrag
import com.breezefieldbluebarry.features.leaderboard.LeaderBoardFrag
import com.breezefieldbluebarry.features.leaveapplynew.LeaveHome
import com.breezefieldbluebarry.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldbluebarry.features.localshops.LocalShopListFragment
import com.breezefieldbluebarry.features.localshops.LocalShopListMapFragment
import com.breezefieldbluebarry.features.localshops.NearByShopsMapFragment
import com.breezefieldbluebarry.features.location.*
import com.breezefieldbluebarry.features.location.api.LocationRepoProvider
import com.breezefieldbluebarry.features.location.model.*
import com.breezefieldbluebarry.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldbluebarry.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldbluebarry.features.login.ShopFeedbackEntity
import com.breezefieldbluebarry.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldbluebarry.features.login.presentation.LoginActivity
import com.breezefieldbluebarry.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldbluebarry.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldbluebarry.features.marketAssist.MarketAssistTabFrag
import com.breezefieldbluebarry.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldbluebarry.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldbluebarry.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldbluebarry.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldbluebarry.features.member.MapViewForTeamFrag
import com.breezefieldbluebarry.features.member.model.TeamLocDataModel
import com.breezefieldbluebarry.features.member.model.TeamShopListDataModel
import com.breezefieldbluebarry.features.member.presentation.*
import com.breezefieldbluebarry.features.menuBeat.MenuBeatFrag
import com.breezefieldbluebarry.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldbluebarry.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldbluebarry.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldbluebarry.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldbluebarry.features.myjobs.model.CustomerDataModel
import com.breezefieldbluebarry.features.myjobs.presentation.*
import com.breezefieldbluebarry.features.myorder.presentation.MyOrderListFragment
import com.breezefieldbluebarry.features.myprofile.presentation.MyProfileFragment
import com.breezefieldbluebarry.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldbluebarry.features.nearbyshops.model.ShopData
import com.breezefieldbluebarry.features.nearbyshops.model.ShopListResponse
import com.breezefieldbluebarry.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldbluebarry.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldbluebarry.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldbluebarry.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldbluebarry.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldbluebarry.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldbluebarry.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldbluebarry.features.newcollection.CollectionShopListFragment
import com.breezefieldbluebarry.features.newcollection.NewCollectionListFragment
import com.breezefieldbluebarry.features.newcollectionreport.*
import com.breezefieldbluebarry.features.notification.NotificationFragment
import com.breezefieldbluebarry.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldbluebarry.features.orderList.NewOrderListFragment
import com.breezefieldbluebarry.features.orderList.OrderListFragment
import com.breezefieldbluebarry.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldbluebarry.features.orderhistory.ActivityMapFragment
import com.breezefieldbluebarry.features.orderhistory.OrderhistoryFragment
import com.breezefieldbluebarry.features.orderhistory.TimeLineFragment
import com.breezefieldbluebarry.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldbluebarry.features.orderhistory.model.FetchLocationRequest
import com.breezefieldbluebarry.features.orderhistory.model.FetchLocationResponse
import com.breezefieldbluebarry.features.orderhistory.model.LocationData
import com.breezefieldbluebarry.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldbluebarry.features.performance.GpsStatusFragment
import com.breezefieldbluebarry.features.performance.PerformanceFragment
import com.breezefieldbluebarry.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldbluebarry.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldbluebarry.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldbluebarry.features.performanceAPP.PerformanceAppFragment
import com.breezefieldbluebarry.features.performanceAPP.allPerformanceFrag
import com.breezefieldbluebarry.features.permissionList.ViewPermissionFragment
import com.breezefieldbluebarry.features.photoReg.*
import com.breezefieldbluebarry.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldbluebarry.features.quotation.presentation.*
import com.breezefieldbluebarry.features.reimbursement.presentation.*
import com.breezefieldbluebarry.features.report.presentation.*
import com.breezefieldbluebarry.features.returnsOrder.*
import com.breezefieldbluebarry.features.settings.presentation.SettingsFragment
import com.breezefieldbluebarry.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldbluebarry.features.shopdetail.presentation.*
import com.breezefieldbluebarry.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldbluebarry.features.stock.StockDetailsFragment
import com.breezefieldbluebarry.features.stock.StockListFragment
import com.breezefieldbluebarry.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldbluebarry.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldbluebarry.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldbluebarry.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldbluebarry.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldbluebarry.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldbluebarry.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldbluebarry.features.survey.SurveyFrag
import com.breezefieldbluebarry.features.survey.SurveyViewDtlsFrag
import com.breezefieldbluebarry.features.survey.SurveyViewFrag
import com.breezefieldbluebarry.features.task.presentation.AddTaskFragment
import com.breezefieldbluebarry.features.task.presentation.CalenderTaskFragment
import com.breezefieldbluebarry.features.task.presentation.EditTaskFragment
import com.breezefieldbluebarry.features.task.presentation.TaskListFragment
import com.breezefieldbluebarry.features.taskManagement.TaskManagementFrag
import com.breezefieldbluebarry.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldbluebarry.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldbluebarry.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldbluebarry.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldbluebarry.features.viewAllOrder.CartFragment
import com.breezefieldbluebarry.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldbluebarry.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldbluebarry.features.viewAllOrder.ViewCartFragment
import com.breezefieldbluebarry.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldbluebarry.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldbluebarry.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldbluebarry.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldbluebarry.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldbluebarry.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldbluebarry.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldbluebarry.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldbluebarry.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldbluebarry.features.viewPPDDStock.ViewStockFragment
import com.breezefieldbluebarry.features.weather.presentation.WeatherFragment
import com.breezefieldbluebarry.mappackage.MapActivity
import com.breezefieldbluebarry.mappackage.MapActivityWithoutPath
import com.breezefieldbluebarry.mappackage.SendBrod
import com.breezefieldbluebarry.widgets.AppCustomEditText
import com.breezefieldbluebarry.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldbluebarrylogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbluebarrylogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefieldbluebarry/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbluebarrylogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbluebarrylogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbluebarrylogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbluebarrylogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
